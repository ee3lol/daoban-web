        ...
        <div className="flex flex-col gap-6">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-4 px-6 py-3.5 bg-accent text-[#F9F8F6] rounded-[14px] font-semibold w-full hover:brightness-110 hover:shadow-[0_0_15px_var(--color-accent)] transition-all duration-300 disabled:opacity-50 tracking-wide "
            >
