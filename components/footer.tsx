...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#111111] border-t border-white/5 pt-16 pb-28 md:pb-8 relative z-50">
      <div className="w-full max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link href="/movies" className="text-[#888888] hover:text-[#D47A73] text-[13px] transition-colors w-fit">Movies</Link>
            <Link href="/tv" className="text-[#888888] hover:text-[#D47A73] text-[13px] transition-colors w-fit">TV Shows</Link>
            <Link href="/anime" className="text-[#888888] hover:text-[#D47A73] text-[13px] transition-colors w-fit">Anime</Link>
            <Link href="/trending" className="text-[#888888] hover:text-[#D47A73] text-[13px] transition-colors w-fit">Trending</Link>
          </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="text-[#888888] text-[11px] tracking-wider uppercase flex items-center gap-1.5 font-medium">
            Made with <span className="text-[#D47A73] text-[14px]">♥</span> for pirates
          </div>
        </div>
      </div>
    </footer>
