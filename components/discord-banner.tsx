      ...
      <div className="relative w-full h-[120px] md:h-[130px] rounded-[6px] overflow-hidden flex items-center border border-white/5 bg-[#111111] group">
        ...
        <div className="relative z-10 px-6 md:px-10 flex flex-row items-center justify-between w-full gap-6">
          ...
          <Link 
            ...
            target="_blank"
            className="px-6 py-3 bg-white/5 hover:bg-white/10 border border-white/10 text-[#EAE8E3] hover:text-[#D47A73] font-bold tracking-[0.1em] uppercase text-[11px] rounded-[4px] transition-colors flex items-center gap-2 backdrop-blur-md shrink-0"
          >
