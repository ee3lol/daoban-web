    ...
    <div className="relative w-full h-[85vh] min-h-[600px] flex items-center overflow-hidden">
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 mt-20">
        <div className="max-w-2xl flex flex-col gap-5 transform transition-all duration-700 translate-y-0 opacity-100">
          ...
          <p className="text-[#888888] text-[12px] sm:text-sm md:text-base leading-[1.6] sm:leading-[1.8] font-medium line-clamp-2 sm:line-clamp-3 md:line-clamp-4 max-w-xl text-balance drop-shadow-md mt-1 sm:mt-2">
          ...
          <div className="flex flex-row items-center w-full sm:w-auto gap-2 sm:gap-4 mt-4 sm:mt-6">
            ...
            <Link
              ...
              className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-2 py-3 sm:px-8 sm:py-4 bg-[rgba(255,255,255,0.03)] hover:bg-[rgba(255,255,255,0.1)] border border-[rgba(255,255,255,0.1)] text-[#EAE8E3] hover:text-white rounded-full font-bold text-[11px] sm:text-[13px] tracking-wider transition-colors duration-300 backdrop-blur-md whitespace-nowrap"
            >
      ...
      <div className="absolute bottom-12 left-1/2 -translate-x-1/2 z-20 flex gap-3">
        {movies.slice(0, 5).map((_, idx) => (
          <button
            ...
            className={`h-1.5 rounded-full transition-all duration-500 ease-out ${idx === currentIndex ? "w-10 bg-accent" : "w-2 bg-[#888888]/30 hover:bg-[#888888]/60 hover:w-4"}`}
